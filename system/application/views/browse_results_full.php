...
if ( ! is_null($results))
{
	 ...
	 {?>
	 	...
	 	<p><b>Showing search results for '<?php 
		echo $search_terms;
	 	...
	 	foreach($results as $result)
		{
			...
			{ ?>
						...
						<p align='justify'><font color="#3D3D3D" style="font-weight:100" ><b>
						<a style="color:#000000; text-decoration:none;font-size:14px; " onmouseover="this.style.color='#FF0000'" onmouseout="this.style.color='#000000'"  href="<?php if($result->url_of_resource) echo $result->url_of_resource ?>"><?php echo highlight_phrase($result->Name_of_Resource, $search_terms, '<span style="color:#F47200">', '</span>'); ?> </a></b></font>
			<?php 
			} ?>
			...
			if($result->view_pub)
			{ ?>
						<a href="<?php echo site_url();?>pages/View_publication/<?php echo $result->master_list?>" target="_blank">(View Publication)</a><?php
			} ?>
