...
if ( ! is_null($course_results))
{
	 if (count($course_results))
	 {
		...
		<h1><font color="#3D3D3D" <b> Total <?php echo $total_results?> Courses Found.</h1> 	 	
...
<?php
			...
			{ ?>
						<b><a href="<?php echo site_url();?>user/edit_course/<?php echo $result->s_no?>" >(Edit Course)</a></b><?php
			} ?>
