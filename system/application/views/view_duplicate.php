	 ...
	 {?>
	 	...
	 	foreach($results as $result)
		{
			...
			{ ?>
						...
						href="<?php echo base_url()."user/show_duplicate/".$result->Name_of_Resource ?>"
						><?php echo $result->Name_of_Resource ?> 
						</a></b></font>
			<?php 
			} ?>
 			<font color="#3D3D3D" style="font-weight:100" > [<b><?php echo $result->duplicate_resources." results under " ?>: </b>
