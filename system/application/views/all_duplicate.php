...
if ( ! is_null($results))
{
	 ...
	 {?>
	 	...
	 	<p style="font-size: 18px"><b>Showing <?php echo count($results) ?> Duplicate Results.</b>
		<br /><br />
	 	...
	 	foreach($results as $result)
		{
			...
			{ ?>
						...
						<a style="color:#000000; text-decoration:none;font-size:18px; " onmouseover="this.style.color='#FF0000'" onmouseout="this.style.color='#000000'" target="_blank" 
						href="<?php echo base_url()."user/show_all_duplicate/".$result->Name_of_Resource ?>"
						><?php echo $result->Name_of_Resource ?> 
						</a></b></font>
			<?php 
			} ?>
 			<font color="#3D3D3D" style="font-weight:100" > [<b><?php echo $result->duplicate_resources." Results Found]" ?> </b>
	...
	{
		?>  <br /><br /><br /><br /><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; No Duplicate Result Found. <?php $flag=true;
