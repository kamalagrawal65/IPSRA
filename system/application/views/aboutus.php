<br>
<div id="main" class="grid_7" style="float:right;"> 	

				<p align="justify" class="content" style='background-color:#eeeeee;'>
								Pharmaceutical Sciences is one of the emerging subjects in recent past which have incorporated many field together. The application of computational approaches to solve biological problem is the key concern of bioinformatics. Biologists working in the field of bioinformatics often come across with lack of key information resources such as software tools, database information, journals along with the association of institutions in order to correlate, compare and keep pace with the fast moving research program in bioinformatics. 
				<br /><br />
				<i>i</i>BIRA (Integrated Bioinformatics Information Resource Access) is an effort to associate bioinformatics people with the Bioinformatics Information Resource, available over worldwide, at a single platform in six leading areas of the bioinformatics which are: Molecular Biology Databases, Institutions working and imparting education in the area of bioinformatics, Journals publishing Bioinformatics articles, Patents in the area of bioinformatics, Software Tools for analyzing Bioinformatics data and Web-servers hosting plethora of bioinformatics data sets. 
				<br /><br />	
