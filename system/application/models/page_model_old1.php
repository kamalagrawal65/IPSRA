...
class Page_model extends Model
{
    ...
    function browse_data($terms, $start = 0, $results_per_page = 0)
		...
		$sql="select master_list,main_clusters,main_category,sub_category,Name_of_Resource from ibira where Name_of_Resource like '";
    ...
    function browse09($start = 0, $results_per_page = 0)
		...
		$sql="select master_list,main_clusters,main_category,sub_category,Name_of_Resource from ibira where Name_of_Resource < 'A'";
	...
	function count_browse09()
    {
	    ...
	    // Run SQL to count the total number of search results
		$sql="SELECT COUNT(*) AS count from ibira where Name_of_Resource < 'A'";
		$query = $this->db->query($sql);
      	return $query->row()->count;
    }
